...
public class TesteCavaloPreguicaCachorro {
	...
	public static void main(String[] args) {
		...
		int op = 0;
		Cachorro dog = new Cachorro("Max", 3,4, "baixa", "ração", "gost muito de correr", "possui os pelos caramelo",
		...
		Cavalo horse = new Cavalo("Logan", 7, 4, "media", "feno",
				"Para fazer exercicios o cavalo deve correr",
				"marrom", "Não cruzou", 88);
		
		Preguica preg = new Preguica("Lana", 4, 4, "Nula", "Folhas", "A preguiça não corre, ela costuma subir em arvores",
		...
		case 3:
			...
			System.out.println(preg.emitirSom());

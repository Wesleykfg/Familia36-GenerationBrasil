...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("É Sobre Isso - Blog Pessoal")
			.description("Projeto É sobre isso Spring - Blog Pessoal")
			.version("1.0.0")
			.license("Apache License Version 2.0")
			.licenseUrl("https://github.com/Wesleykfg")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Wesley Gomes", 
			"https://github.com/Wesleykfg", 
			"wesleykelvin59@gmail.com");
